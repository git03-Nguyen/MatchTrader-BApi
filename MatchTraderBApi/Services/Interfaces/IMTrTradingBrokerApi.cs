...
public interface IMTrTradingBrokerApi
{
  ...
  /// <returns></returns>
  Task<MTrResponse<MTrGetSymbolsResponse>> GetSymbols(string systemUuid, string group, IEnumerable<string>? symbols, CancellationToken cancellationToken = default);
  ...
  /// <param name="cancellationToken"></param>
  /// <returns></returns>
  Task<MTrResponse<MTrGetLedgersResponse>> GetLedgers(string systemUuid, string login, IEnumerable<MTrLedgerType> types, DateTimeOffset? from = null, DateTimeOffset? to = null, int? limit = null, CancellationToken cancellationToken = default);
  ...
  /// <param name="cancellationToken"></param>
  /// <returns></returns>
  Task<MTrResponse<List<MTrGroupConfiguration>>> GetGroups(string systemUuid, IEnumerable<string> names, CancellationToken cancellationToken = default);
