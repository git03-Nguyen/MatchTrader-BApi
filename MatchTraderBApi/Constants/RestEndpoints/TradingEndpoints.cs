...
{
    internal static string GetSymbols(string systemUuid, string group, IEnumerable<string>? symbols)
        => symbols is null
    ...
    internal static string CloseAllPositions() => "/v1/trading-accounts/positions/close-all";
}